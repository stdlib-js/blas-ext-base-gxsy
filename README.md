...
```javascript
import gxsy from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gxsy@deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gxsy@deno/mod.js';
```
...
[@stdlib/blas/ext/base/gaxpby]: https://github.com/stdlib-js/blas-ext-base-gaxpby/tree/deno
